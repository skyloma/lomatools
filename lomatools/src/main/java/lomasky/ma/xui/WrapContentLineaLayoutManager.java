...
public class WrapContentLineaLayoutManager extends LinearLayoutManager {

	private static final int CHILD_WIDTH = 0;
	private static final int CHILD_HEIGHT = 1;
	private static final int DEFAULT_CHILD_SIZE = 100;
	private static final String TAG =WrapContentLineaLayoutManager.class.getName() ;
	...
	public WrapContentLineaLayoutManager(Context context) {
		super(context);
	}

	@SuppressWarnings("UnusedDeclaration")
	public WrapContentLineaLayoutManager(Context context, int orientation, boolean reverseLayout) {
